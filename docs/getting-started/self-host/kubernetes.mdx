...
Now, you can access the Helicone web interface at `http://localhost:3020`.
...
Then, navigate to `http://localhost:8989/project/default/auth/users` in your browser and add your account. You can use this account to sign into Helicone at `http://localhost:3020`.

</Note>

**Default URLs:**

- Helicone Web Interface: `http://localhost:3020`
