...
ssh -vv -i ~/Desktop/jump-host-prod.pem -L 54328:remote_proxy_address:5444 ubuntu@34.211.102.63 -N
...
flyway -url="jdbc:postgresql://localhost:54448/helicone" -user="root" -locations=filesystem:./migrations  migrate
```
